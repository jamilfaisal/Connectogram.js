...
// Edges
cg.connect(blobRect, blobRect2, "dotted", "blue", 5)
cg.connect(blobCirc, blobEllip, "dashed", "red", 10)
cg.connect(blobCirc, blobRect, null, "green", 1)
cg.connect(blobCirc, blobRect2, null, "brown", 3)
// Text
